...
def find_way(start, gold, blizzards):
...
time1, new_blizzards = find_way(START, END, blizzards)
time2, new_blizzards = find_way(END, START, new_blizzards)
time3, _ = find_way(START, END, new_blizzards)
